...
const api = {
  ...
  secrets: {
    ...
    readGithubToken: (): Promise<string | null> => ipcRenderer.invoke('secrets:readGithubToken'),
  },
  ...
  tools: {
    ...
    }): Promise<{ ok: true; remote: unknown }> => ipcRenderer.invoke('tools:setRemoteAccess', opts),
