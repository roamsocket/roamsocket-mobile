...
function isHostAllowed(host: string, policy: { access: string; allowedDomains: string[] }): boolean {
...
function networkViolationMessage(command: string, policy: { access: string; allowedDomains: string[] }): string {
