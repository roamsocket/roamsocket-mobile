  ...
  connectors: [
    {
      id: 'cashapp',
      name: 'Cash App',
      description: 'Send and request money with Cash App.',
      available: true,
      category: 'finance',
    },
    {
      id: 'figma',
      name: 'Figma',
      description: 'Browse design files and frames from Figma.',
      available: true,
      category: 'design',
    },
    {
      id: 'gmail',
      name: 'Gmail',
      description: 'Search and summarize email from Gmail.',
      available: true,
    ...
    },
    {
      id: 'godaddy',
      name: 'GoDaddy',
      description: 'Domain and DNS management via GoDaddy.',
      available: true,
      category: 'web',
    },
    {
      ...
      description: 'Upcoming events and scheduling context.',
      available: true,
      category: 'productivity',
    },
    {
      id: 'gdrive',
      name: 'Google Drive',
      description: 'Find and summarize Drive documents.',
      available: true,
      category: 'productivity',
    },
    {
      id: 'granola',
      name: 'Granola',
      description: 'Meeting notes from Granola.',
      available: false,
      category: 'productivity',
    },
    {
  ...
  plugins: [
    {
      id: 'marketing-kit',
      name: 'Marketing kit',
      description: 'Landing pages, campaigns, and brand voice helpers.',
      category: 'marketing',
      skillIds: ['frontend-design-css', 'theme-factory'],
      featured: true,
    },
    {
      id: 'productivity-kit',
      name: 'Productivity kit',
      description: 'Daily briefs, internal comms, and doc coauthoring.',
      category: 'productivity',
      skillIds: ['morning', 'internal-comms', 'doc-coauthoring'],
      featured: true,
    },
    {
      id: 'engineering-kit',
      name: 'Engineering kit',
      description: 'MCP builders and developer-oriented skills.',
      category: 'engineering',
      skillIds: ['mcp-builder', 'skill-creator'],
      featured: true,
    },
    {
      id: 'design-kit',
      name: 'Design kit',
      description: 'Canvas layout and theme tokens.',
      category: 'design',
      skillIds: ['canvas-design', 'theme-factory'],
      featured: false,
    },
  ],
  pluginCategories: [
